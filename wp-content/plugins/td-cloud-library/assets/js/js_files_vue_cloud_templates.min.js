...
success:function(a){a=JSON.parse(a);"undefined"!==typeof a.mobile_template_id?(b.cancelAddNewMobTpl(),"woo_archive"===b.templateType||"woo_archive_tag"===b.templateType||"woo_archive_attribute"===b.templateType?jQuery("body").trigger("tdb_ct_tpl_card_data_update_woo_archive"):b.getTemplateCardData({callback:function(){"cpt_tax"===b.templateType&&window.eventHub.$emit("refresh-cpt-tax",b.templatesCardData.templates,b.templatesCardData.mobile_templates)}}),"page"===b.templateType?jQuery("body").trigger("tdb_ct_tpl_card_data_update_homepage"):
"homepage"===b.templateType&&jQuery("body").trigger("tdb_ct_tpl_card_data_update_page")):(b.errors.push({type:a.type,message:"tpl card create mobile tpl error: "+a.msg}),b.cancelAddNewMobTpl())},error:function(a,b,e){console.log("%c"+e,"color: #dc2121c7")}})}},setMobileTpl:function(a,b){var c=this;c.errors=[];jQuery.ajax({type:"post",url:td_ajax_url,data:{action:"tdb_set_mobile_template",template_id:a,mobile_template_id:b,_nonce:window.tdb_globals.wpRestNonce},success:function(a){a=JSON.parse(a);
_.isObject(a)&&!_.isUndefined(a.result)&&1===a.result?c.getTemplateCardData({callback:function(){"cpt_tax"===c.templateType&&window.eventHub.$emit("refresh-cpt-tax",c.templatesCardData.templates,c.templatesCardData.mobile_templates)}}):c.errors.push({type:a.type,message:"tpl card set mobile template error: "+a.msg})},error:function(a,b,c){console.log("%c"+c,"color: #dc2121c7")}})},cancelAddNewMobTpl:function(){this.newMobileTplName=this.template="";this.copyContent=this.showMobileTplModal=!1},setTemplateNameEditDisplay:function(){var a=
...
typeof b.$refs[a[0]][0]&&b.$refs[a[0]][0].focus()})})},saveTemplateRename:function(a){var b=this;b.editedTplName!==a.post_title?(b.templatesNameSaving["tpl_name_edit_saving_"+a.ID]=!b.templatesNameSaving["tpl_name_edit_saving_"+a.ID],jQuery.ajax({url:td_ajax_url,type:"post",data:{action:"tdb_change_template_name",template_id:a.ID,template_title:b.editedTplName,_nonce:window.tdb_globals.wpRestNonce},success:function(c){c=JSON.parse(c);"undefined"!==typeof c.template_id?(a.post_title=b.editedTplName,
b.templatesNameSaving["tpl_name_edit_saving_"+a.ID]=!b.templatesNameSaving["tpl_name_edit_saving_"+a.ID],b.templatesNameEditing["tpl_name_edit_"+a.ID]=!b.templatesNameEditing["tpl_name_edit_"+a.ID],(b.templateType.startsWith("pa_")||"woo_archive"===b.templateType||"woo_archive_tag"===b.templateType||"woo_archive_attribute"===b.templateType)&&jQuery("body").trigger("tdb_ct_tpl_card_data_update_woo_archive"),"cpt_tax"===b.templateType&&window.eventHub.$emit("refresh-cpt-tax",b.templatesCardData.templates,
b.templatesCardData.mobile_templates)):b.errors.push({type:c.type,message:"tpl card change template name error: "+c.msg})},error:function(a,b,e){console.log("%c"+e,"color: #dc2121c7")}})):b.cancelTemplateRename(a)},cancelTemplateRename:function(a){this.templatesNameEditing["tpl_name_edit_"+a.ID]=!this.templatesNameEditing["tpl_name_edit_"+a.ID]},blur:function(a){a.target.blur()},templateDuplicate:function(a){var b=this,c="";switch(b.templateType){case "page":case "homepage":c="page";break;case "woo_archive_attribute":case "woo_archive_tag":c=
"woo_archive";break;default:c=b.templateType.startsWith("pa_")?"woo_archive":b.templateType}b.errors=[];tdbApi.run({wpNonce:window.tdb_globals.wpRestNonce,cloudEndPoint:"td-cloud-library/new_template",post:{postId:a.ID,templateType:c,templateName:a.post_title,duplicateTemplate:!0},done:function(a){"undefined"!==typeof a.template_id?b.templateType.startsWith("pa_")||"woo_archive"===b.templateType||"woo_archive_tag"===b.templateType||"woo_archive_attribute"===b.templateType?jQuery("body").trigger("tdb_ct_tpl_card_data_update_woo_archive"):
b.getTemplateCardData({callback:function(){"cpt_tax"===b.templateType&&window.eventHub.$emit("refresh-cpt-tax",b.templatesCardData.templates,b.templatesCardData.mobile_templates)}}):b.errors.push({type:"error",message:"tpl card duplicate template error: "+a.error})},error:function(a){console.log("td-cloud-library/new_template ( duplicate template ) - ERROR",a)}})},templateDelete:function(a,b){b=void 0===b?!1:b;var c=this;c.errors=[];jQuery.ajax({type:"POST",url:td_ajax_url,data:{action:"tdb_delete_template",
template_id:a,_nonce:window.tdb_globals.wpRestNonce},success:function(a){a=JSON.parse(a);"undefined"!==typeof a.template_id?(c.templateType.startsWith("pa_")||"woo_archive"===c.templateType||"woo_archive_tag"===c.templateType||"woo_archive_attribute"===c.templateType?jQuery("body").trigger("tdb_ct_tpl_card_data_update_woo_archive"):c.getTemplateCardData({callback:function(){"cpt_tax"===c.templateType&&window.eventHub.$emit("refresh-cpt-tax",c.templatesCardData.templates,c.templatesCardData.mobile_templates)}}),
